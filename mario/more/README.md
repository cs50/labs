...
Notice that width of the "gap" between adjacent pyramids is equal to the width of two hashes, irrespective of the pyramids' heights.  Also be aware that there shouldn't be any spaces to the right of the pyramid; it's not fully symmetrical.
...
```
submit50 cs50/problems/2019/x/mario/more
```
